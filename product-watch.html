            ...
            <div class="col-sm products-right">
              <article class="product product-laptop">
                <div class="product-layout">
                  <img src="assets/img/Watch/Mi Smart Band 5/Mi Smart Band 5.png" alt="Featured 1" class="product_img watch" />
                </div>
                <span class="product_name">Mi Smart Band 5</span>
              ...
              <article class="product product-laptop">
                <div class="product-layout">
                  <img src="assets/img/Watch/Mi Watch/black.png" alt="Featured 1" class="product_img watch" />
                </div>
                <span class="product_name">Mi Watch</span>
                <span class="product_price">Rp 30.000.000</span>
                <a href="#" class="button-light">Lihat Produk <i class="bx bx-right-arrow-alt button-icon"></i></a>
              </article>
              <article class="product product-laptop">
                <div class="product-layout">
                  <img src="assets/img/Watch/Mi Watch Lite/navy blue.png" alt="Featured 1" class="product_img watch" />
                </div>
                <span class="product_name">Mi Watch Lite</span>
                <span class="product_price">Rp 30.000.000</span>
                <a href="#" class="button-light">Lihat Produk <i class="bx bx-right-arrow-alt button-icon"></i></a>
              </article>
              <article class="product product-laptop">
                <div class="product-layout">
                  <img src="assets/img/Watch/Realme Watch/Realme Watch.png" alt="Featured 1" class="product_img watch" />
                </div>
                <span class="product_name">Realme Watch</span>
                <span class="product_price">Rp 30.000.000</span>
                <a href="#" class="button-light">Lihat Produk <i class="bx bx-right-arrow-alt button-icon"></i></a>
              </article>
              <article class="product product-laptop">
                <div class="product-layout">
                  <img src="assets/img/Watch/Realme Watch Pro 2/Black.png" alt="Featured 1" class="product_img watch" style="width: 80px" />
                </div>
                <span class="product_name">Realme Watch Pro</span>
                <span class="product_price">Rp 30.000.000</span>
                <a href="#" class="button-light">Lihat Produk <i class="bx bx-right-arrow-alt button-icon"></i></a>
              </article>
            </div>
