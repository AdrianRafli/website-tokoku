      ...
      if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
        // Jika gambar berhasil diupload, Lakukan :  
         // Proses simpan ke Database
          $input = mysqli_query($conn, "INSERT INTO produk (namaproduk,idkategori,idbrand,gambar1,deskripsi,hargabefore,hargaafter) VALUES('$namaproduk','$idkategori','$idbrand','$nama_file','$deskripsi','$hargabefore','$hargaafter')");
          ...
          if($input){ // Cek jika proses simpan ke database sukses atau tidak
            ...
            // Jika Gagal, Lakukan :
            $error = true;
            $message = "Maaf, terjadi kesalahan saat membuat produk";
        }
    }else{
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $no++ ?></td>
											<td><img src="../assets/img/produk/<?= $p['gambar1'] ?>" width="50%"\></td>
											<td><?= $p['namaproduk'] ?></td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="edit-produk.php?id=<?= $p['idproduk'] ?>">
                                                        <button type="button" class="btn btn-sm btn-primary mx-1">Edit</button>
                                                    </a>
                                                    <a href="delete-produk.php?id=<?= $p['idproduk'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ini?')">
