...
$hasil = mysqli_query($conn, "SELECT * FROM pembayaran WHERE no=$id");
...
if (isset($_POST["update"])) {
  ...
  // Cek Duplikasi 
    $result = mysqli_query($conn, "UPDATE pembayaran SET metode='$nama', norek='$norek', an='$an' WHERE no=$id");
    if($result) {
      $berhasil = true;
    } else {
      $error = true;
                        ...
                        <?php 
                            ...
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="norek" name="norek" value="<?= $vnorek ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="an" class="form-label">Atas Nama</label>
                                    <input type="text" class="form-control" id="an" name="an" value="<?= $van ?>">
                                </div>
                                <div class="mb-3">
